                      ...
                      Stack(
                          ...
                          Container(
                            ...
                            decoration: const BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: AssetImage("assets/images/140127103345-peninsula-shanghai-deluxe-mock-up.jpg"),
                                  fit: BoxFit.fill),
                            ),
                          ),
                          const Positioned(
                       ...
                       Padding(padding: const EdgeInsets.only(top: 20,left: 15),
                         child:   Column(
                               crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  const Text("Awesome room near Munnar",style: TextStyle(fontWeight: FontWeight.bold,
                                  fontSize: 20),),
                                  const Text("Munnar,Kerala",style: TextStyle(fontSize: 15),),
                                 ...
                                 child: Row(
                                    ...
                                    children: [
                                      ...
                                      const Icon(Icons.star_outlined,color: Colors.green,size: 20,),
                                      const Icon(Icons.star_outlined,color: Colors.green,size: 20,),    
                                      const Text('(224 reviews)',style: TextStyle(color: Colors.black54),),   
                                    ],
